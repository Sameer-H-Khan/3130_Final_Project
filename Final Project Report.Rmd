...
# Relationship between BMI and number of followers
plot(ig_users$BMI, ig_users$Followers)
BMI_vs_Followers_Model <- lm(ig_users$Followers ~ ig_users$BMI, data = ig_users)
